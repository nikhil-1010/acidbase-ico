    ...
    <div class="bg-dark">
        ...
        <section class="hero-banner text-white position-relative overflow-hidden">
            <div class="hero-video position-absolute top-0 bottom-0 m-auto">
                <video width="100%" height="100%" poster="{{url('assets/img/metrix-video.png')}}" muted="" autoplay="" loop="" playsinline="">
                    <source src="{{url('assets/img/metrix-video.mp4')}}" type="video/mp4">
                </video>
            </div>
            <div class="container h-100 position-relative">
                <div class="row align-items-center justify-content-center h-100">
                    <div class="col-lg-8">
                        <h1 class="section-title display-3 text-uppercase">Immortalise your legacy with Acidbase, Live Forever</h1>
                    </div>
                    <div class="col-lg-4">
        ...
        <section class="container text-center pb-5">
            <h2 class="section-title display-5 text-uppercase text-white">Our Presale Ends in</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="bg-light p-5 shadow-lg h-100">
                            <div class="d-flex gap-4 align-items-start">
                                ...
                                <div>
                                    <h5 class="mb-3 text-secondary text-uppercase">
                                        The future of AI: Enter Acidbase
                                    </h5>
                                    <p class="m-0 fw-lighter">Acidbase's unique combination of blockchain, AI, and NFTs empowers you with unprecedented control over your personal data, creating a decentralized, secure, and transparent platform for AI-powered digital personas.
                                        This groundbreaking approach positions Acidbase as a leading project in the fast-growing blockchain industry, offering a personalized and private digital experience.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-light p-5 shadow-lg h-100">
                            <div class="d-flex gap-4 align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="m-0 fw-lighter">Acidbase offers you a chance to create an AI-driven digital persona that captures your essence and interacts with future generations. Through advanced AI algorithms, Acidbase preserves your legacy, allowing for a form
                                        of immortality where your life story and experiences are passed down for generations to come.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="inner-space text-center">
            <div class="container">
                <h2 class="section-title display-5 text-uppercase text-secondary">ROADMAP</h2>
                <p class="fw-lighter text-white mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            ...
            <div class="container">
                <div class="row g-4 align-items-center justify-content-between">
                    ...
                    <div class="col-lg-4 col-md-5">
                        <img src="{{url('assets/img/acidbase-icon.png')}}" alt="" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </section>
