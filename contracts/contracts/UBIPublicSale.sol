...
contract UBIPublicSale {
    ...
    constructor() {
        ...
        whiteListTokenAddress[0xdAC17F958D2ee523a2206206994597C13D831ec7] = 182;
        whiteListTokenAddress[0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48] = 182;
    }
    ...
    function addInvestor(address token, uint256 _ubiAmount) external {
        ...
        uint256 usd_amount = _ubiAmount / ( (exchangeRate * (10**(ubi_decimal-decimal)) / 100)) ;
    ...
    function calcVestingduration(address _address) internal view returns(uint totalMonths, uint leftamount) {
        ...
        leftamount = ((investors[_address].lockedUbi*766)/10000)*totalMonths;
        if(totalMonths + investors[_address].claimCounter >= vestingDuration) 
